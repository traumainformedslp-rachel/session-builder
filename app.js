...
var COMPONENTS = [
  ...
  {id:"irregular",label:"Irregular / Heart Words",desc:"High-frequency words with irregular spellings",icon:"\u2764\uFE0F",min:5,cat:"word",mode:"both",color:"#F5D5E8",targets:["Heart word introduction (new)","Heart word review (previously taught)","Heart word reading flash","Heart word spelling practice","Mapping regular vs. irregular parts","Dolch Pre-Primer (a, and, away, big, blue...)","Dolch Primer (all, am, are, at, ate...)","Dolch 1st Grade (after, again, an, any, as...)","Dolch 2nd Grade (always, around, because, been, before...)","Dolch 3rd Grade (about, better, bring, carry, clean...)","Fry First 100","Fry Second 100","Fry Third 100","UFLI heart words (current lesson)","Scope Level 1 learned words (a, the, I, is, was, said...)","Scope Level 2 learned words (come, does, gone, their, there...)","Scope Level 3 learned words (could, would, should, because, people...)","Scope Level 4 learned words (through, thorough, thought, beauty, enough...)","High-frequency verbs (said, were, was, have, does...)","Functional sight words (exit, danger, restroom, open, closed...)","Content-area high-frequency words"]},
