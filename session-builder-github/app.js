...
var COMPONENTS = [
  ...
  {id:"irregular",label:"Irregular / Heart Words",desc:"High-frequency words with irregular spellings",icon:"\u2764\uFE0F",min:5,cat:"word",mode:"both",color:"#F5D5E8",targets:["Heart word introduction (new)","Heart word review (previously taught)","Heart word reading flash","Heart word spelling practice","Mapping regular vs. irregular parts"]},
